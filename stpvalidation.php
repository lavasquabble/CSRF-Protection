                  ...
                  <div class="col-sm-2"></div>
                    <div class="col-sm-8">
                          ...
                          echo "<div class='alert alert-warning' role='alert'>"."You are CSRF free.."."</div>";
          							...
          							{
          								echo "<script>alert('WARNING :: CSRF Not Found !!!')</script>";
          							}

          						}
                      else{
                        echo "<h3>Invalid SESSION... TRY AGAIN</h3><br><a href='dsclogin.php' class='button'><button type='submit' class='btn btn-warning' id='dsc' name='dsc'> Login </button></a>";
                      }
          						?>
